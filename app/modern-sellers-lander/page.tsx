...
export default function ModernSellersLanderPage() {
  return (
    <div className="relative min-h-screen bg-white flex flex-col">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Know What Your Business Is Really Worth — and How to Increase It.
              </h1>
              <p className="text-xl md:text-2xl text-gray-300 mb-6 leading-relaxed">
                Instant valuation and improvement insights powered by $500M+ in real Australian sales data.
              </p>
            ...
            >
              <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-md mx-auto">
                ...
                <div className="flex items-center justify-between mb-4 pb-4 border-b">
                  <h3 className="font-bold text-[#23235B]">Valuation Report</h3>
                ...
                <div className="space-y-4">
                  <div className="bg-[#F5F7FB] rounded-lg p-4">
                    ...
                    <p className="text-2xl font-bold text-[#23235B]">$450K</p>
                  </div>
                  <div className="bg-[#F5F7FB] rounded-lg p-4">
                    <p className="text-sm text-gray-600 mb-1">Growth Opportunities</p>
                    <p className="text-lg font-semibold text-[#4F5DFF]">3 identified</p>
                  </div>
                  <div className="bg-[#F5F7FB] rounded-lg p-4">
                    <p className="text-sm text-gray-600 mb-1">Market Score</p>
                    <div className="flex items-center gap-2">
                      <div className="flex-1 bg-gray-200 rounded-full h-2">
                        <div className="bg-[#4F5DFF] h-2 rounded-full" style={{ width: '75%' }}></div>
                      </div>
                      <span className="text-lg font-semibold text-[#23235B]">75%</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 bg-[#E6E9F8] rounded-lg p-3 flex items-start gap-2">
                  ...
                  <p className="text-sm text-[#23235B]">Your report is ready!</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="flex gap-4 items-end">
                ...
                <div className="bg-gray-200 rounded-xl p-6 opacity-60 flex-1">
                  ...
                  <p className="text-2xl font-bold text-gray-500">$200K</p>
                </div>
                {/* True Value Card */}
                <div className="bg-[#4F5DFF] rounded-xl p-6 flex-1 shadow-lg">
                  <p className="text-sm text-white mb-2">True Value</p>
              ...
              <div className="mt-6">
                <div className="flex gap-2">
                  ...
                  <div className="flex-1 bg-[#4F5DFF] rounded h-4"></div>
                </div>
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#23235B] mb-10">
                Most Owners Sell for Less Than They Could Have.
              </h2>
              <p className="text-lg text-[#23235B] mb-4">
                Without clear data, many business owners accept low offers or sell too soon.
              </p>
              <p className="text-lg text-[#23235B] font-semibold">
                DealBase shows your true value — and what's quietly dragging it down.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-[#23235B] mb-2">Enter your business details</h3>
            </motion.div>
            ...
            >
              ...
              <div className="bg-[#F5F7FB] rounded-lg p-6 mb-4 h-32 flex items-center justify-center">
                <div className="w-full space-y-2 text-left">
                  <div className="bg-white rounded p-2 text-xs text-[#23235B]">✓ Customer Retention</div>
                  <div className="bg-white rounded p-2 text-xs text-[#23235B]">✓ Profit Margin</div>
                  <div className="bg-white rounded p-2 text-xs text-[#23235B]">✓ Growth Rate</div>
                </div>
              </div>
              <h3 className="text-xl font-bold text-[#23235B] mb-2">See what's helping or hurting your price</h3>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-white py-32 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#23235B] mb-10">
                Built by Brokers. Backed by Data.
              </h2>
              <p className="text-lg text-[#23235B] mb-4">
                Unlike online calculators, DealBase uses verified sales data and valuation logic trusted by Australian brokers.
              </p>
              <p className="text-lg text-[#23235B] font-semibold">
                It doesn't just tell you what you're worth — it shows you why.
              </p>
            </motion.div>
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gray-200 rounded-xl p-4 opacity-60">
                  <p className="text-xs text-gray-600 mb-2">Generic Calculator</p>
                ...
                <div className="bg-white border-2 border-[#4F5DFF] rounded-xl p-4 shadow-lg">
                  <p className="text-xs font-semibold text-[#23235B] mb-2">DealBase Report</p>
                  <div className="space-y-2 mb-2">
                    <div className="bg-green-100 rounded p-1 text-xs text-green-700">Customer Retention ↑</div>
                    <div className="bg-red-100 rounded p-1 text-xs text-red-700">Profit Margin ↓</div>
                  </div>
                  <div className="bg-[#F5F7FB] rounded p-2">
                    <p className="text-sm font-bold text-[#23235B]">$450K</p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      {/* Section 4: For Business Owners (Not Just Sellers) */}
      <section className="w-full bg-[#F5F7FB] py-32 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            {/* Left: Visual */}
            ...
            >
              <div className="bg-white rounded-2xl shadow-lg p-6 max-w-sm mx-auto">
                <h3 className="font-bold text-[#23235B] mb-4">Business Health Check</h3>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-[#23235B]">Customer Base</span>
                  </div>
                  <div className="flex items-center gap-2">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#23235B] mb-10">
                You Don't Need to Be Selling to Know Your Worth.
              </h2>
              <p className="text-lg text-[#23235B]">
                Most use DealBase as a business health check — a snapshot of performance and improvement areas before they even consider selling.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <p className="text-lg text-[#23235B]">
                Your valuation is private and secure. Only verified buyers under NDA can view your business — and only when you allow it.
              </p>
            </motion.div>
              ...
              <div className="relative">
                <div className="bg-[#F5F7FB] rounded-2xl p-8 shadow-lg border-2 border-[#4F5DFF]">
                  <div className="flex items-center justify-center mb-4">
                    <div className="relative">
                      <svg className="w-16 h-16 text-[#4F5DFF]" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clipRule="evenodd" />
                      </svg>
                      <div className="absolute -top-2 -right-2 w-8 h-8 bg-[#4F5DFF] rounded-full flex items-center justify-center">
                  ...
                  <p className="text-center text-[#23235B] font-semibold">Confidential</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            >
              ...
              <p className="text-[#23235B] mb-4 italic">
                "Helped me understand my business value for the first time."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#E6E9F8] rounded-full flex items-center justify-center">
                  <span className="text-[#4F5DFF] font-bold">C</span>
                </div>
                <div>
                  <p className="font-semibold text-[#23235B]">Café Owner</p>
            ...
            >
              ...
              <p className="text-[#23235B] mb-4 italic">
                "So simple — and the insights were gold."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#E6E9F8] rounded-full flex items-center justify-center">
                ...
                <div>
                  <p className="font-semibold text-[#23235B]">Tradesperson</p>
            ...
            >
              ...
              <p className="text-[#23235B] mb-4 italic">
                "Gave me confidence to raise my asking price."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-[#E6E9F8] rounded-full flex items-center justify-center">
                  <span className="text-[#4F5DFF] font-bold">E</span>
                </div>
                <div>
                  <p className="font-semibold text-[#23235B]">eCommerce Operator</p>
      ...
      <section className="w-full bg-white py-32 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-extrabold text-[#23235B] mb-10">
              DealBase vs Traditional Brokers
            </h2>
          </motion.div>
              ...
              <table className="w-full">
                <thead className="bg-[#23235B] text-white">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-center font-semibold">Broker</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  ...
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-center text-[#23235B]">Weeks</td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 font-semibold text-[#23235B]">Privacy</td>
                    <td className="px-6 py-4 text-center text-[#4F5DFF] font-bold">Full</td>
                    <td className="px-6 py-4 text-center text-[#23235B]">Often public</td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-center text-[#23235B]">Rarely</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="bg-white rounded-2xl shadow-lg p-6 max-w-sm mx-auto">
                <div className="mb-4">
                  <h3 className="font-bold text-[#23235B] mb-2">Business Value Tracker</h3>
                ...
                <div className="flex gap-2 justify-center">
                  <div className="w-8 h-8 bg-gray-200 rounded flex items-center justify-center text-xs">S</div>
                  <div className="w-8 h-8 bg-gray-200 rounded flex items-center justify-center text-xs">X</div>
                  <div className="w-8 h-8 bg-gray-200 rounded flex items-center justify-center text-xs">B</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#23235B] mb-10">
                Your Business Value, Updated in Real Time.
              </h2>
              <p className="text-lg text-[#23235B]">
                Soon, you'll be able to link your business data to track value automatically — like a fitness tracker for your company.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              Get your instant valuation (normally $497) and see how to raise your sale price — free for a limited time.
            </p>
